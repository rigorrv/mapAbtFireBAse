...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void enviarNotificacion(RemoteMessage remoteMessage) {
        Log.d("Notificaciones", ""+MainActivity.NotificationsBoolena);
        //si MainActivity.Notifications == debe de activar notificaciones

        if (MainActivity.NotificationsBoolena == true) {
            ...
            MapsActivity.ColorSelectionLight = "1";
        ...
        if (MainActivity.NotificationsBoolena == false) {
            Log.d("mensaje Notificacion", "desactivado");
        }
    }
    ...
    private void enviarTokenToServer(final String token) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                "http://nonstopcode.com/NotificacionesFCM/registrarToken.php",
